...
#######################################################################
# locals {
#   node_group_name = "${data.terraform_remote_state.eks.outputs.cluster_name}-nodegroup-public" 
#   public_subnet_id = data.terraform_remote_state.eks.outputs.vpc_public_subnets
#   private_subnet_id = data.terraform_remote_state.eks.outputs.vpc_private_subnets
# }
